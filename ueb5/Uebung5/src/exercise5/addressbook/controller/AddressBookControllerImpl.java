 ...
 */
package exercise5.addressbook.controller;
...
import exercise5.addressbook.model.Gender;
import exercise5.addressbook.model.SizeLimitReachedException;
...
public class AddressBookControllerImpl implements AddressBookController {
	...
	/*
	 * (non-Javadoc)
	 * @see addressbook.controller.AddressBookController#load()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see addressbook.controller.AddressBookController#save()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see addressbook.controller.AddressBookController#add(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	public void add(String firstName, String lastName, String gender, String dateOfBirth,
		...
		entry.setDateOfBirth(Entry.dateFormatter.parseDateTime(dateOfBirth));
	...
	/*
	 * (non-Javadoc)
	 * @see addressbook.controller.AddressBookController#remove(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see addressbook.controller.AddressBookController#erase()
	 */
	@Override
	public void erase() {
		// Delete all entries
