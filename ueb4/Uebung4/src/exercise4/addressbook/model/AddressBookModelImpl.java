 ...
 */
package exercise4.addressbook.model;
...
public class AddressBookModelImpl implements AddressBookModel {
	...
	public final static int sizeLimit = 20;

	/**
	 * Default Ctor.
	 * file defaults to "contacts.xml"
	 */
	public AddressBookModelImpl() {
		this(new File("contacts.xml"));
	}
	...
	/* (non-Javadoc)
	 * @see addressbook.model.AddressBookAccess#getEntry(java.lang.String, java.lang.String)
	 */
	@Override
	public Entry getEntry(String surName, String firstName) {
		// This look-up strategy is sub-optimal
		for (Entry e: entries) {
			if (e.getSurName().equalsIgnoreCase(surName) && e.getFirstName().equalsIgnoreCase(firstName)) {
	...
	/* (non-Javadoc)
	 * @see addressbook.model.AddressBookAccess#erase()
	 */
	@Override
	public void erase() {
		entries.clear();
	...
	/*
	 * (non-Javadoc)
	 * @see addressbook.model.AddressBookAccess#getEntries()
	 */
	@Override
