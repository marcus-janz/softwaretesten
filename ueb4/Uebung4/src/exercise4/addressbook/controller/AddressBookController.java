...
import exercise4.addressbook.model.PersistentStorageAccess;
...
public interface AddressBookController extends PersistentStorageAccess {
	 ...
	 * @param dateOfBirth The date of birth (e.g. 3.11.1972) 
	 ...
	 */
	void add(String firstName, String lastName, String gender, String dateOfBirth, String phoneContactInformation, String emailContactInformation) throws ParameterException, SizeLimitReachedException;
