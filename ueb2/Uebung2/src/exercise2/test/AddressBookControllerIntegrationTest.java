...
public class AddressBookControllerIntegrationTest {
	...
	/*
	 *  Aufgabe 4
	 *  Programmieren Sie einen Integrationstest für
	 *  AddressBookModel und AddressBookController.
	 *  •  Testen Sie, ob die Methoden des AddressBookController Interface zu den erwarteten Resultaten im Addressbuch führen.
